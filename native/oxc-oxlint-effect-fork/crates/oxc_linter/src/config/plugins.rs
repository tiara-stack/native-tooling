...
bitflags! {
    ...
    pub struct LintPlugins: u16 {
        ...
        /// `eslint-plugin-vue`
        const VUE = 1 << 13;
        /// Effect diagnostics forwarded to tsgolint.
        const EFFECT = 1 << 14;
    }
}
...
impl Default for LintPlugins {
    ...
    fn default() -> Self {
        ...
        LintPlugins::UNICORN | LintPlugins::TYPESCRIPT | LintPlugins::OXC | LintPlugins::EFFECT
    }
}
