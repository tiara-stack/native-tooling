...
This project originated in [typescript-eslint/tsgolint](https://github.com/effect-ts/tsgo/tsgolint), with fork permission granted by [@auvred](https://github.com/auvred).
